...
dim(endemics)
endemics$Combined.Name <- gsub(endemics$Combined.Name, pattern = " ", replacement = "_")
head(v6tax_edit)

endemics.taxref <- merge(endemics, v6tax_edit, by.x=1, by.y=3)
write.csv(endemics.taxref, "data/TaxRef/endemics.taxref.csv")
