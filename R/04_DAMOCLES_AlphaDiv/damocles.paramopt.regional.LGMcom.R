...
for (i in 1:30){
  ...
  write.csv(opt.params.spermatophyta, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.spermatophyta.", i, ".csv", sep=""))
  ...
  write.csv(opt.params.asterales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.asterales.", i, ".csv", sep=""))
  ...
  write.csv(opt.params.poales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.poales.", i, ".csv", sep=""))
  ...
  write.csv(opt.params.rosales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.rosales.", i, ".csv", sep=""))
  ...
  write.csv(opt.params.lamiales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.lamiales.", i, ".csv", sep=""))
  ...
  write.csv(opt.params.caryophyllales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/LGM/clades/opt.params.caryophyllales.", i, ".csv", sep=""))
