...
source("R/functions/chooseClade.R")  #generates alps.summits.pa
...
alps.damocles.sperma <- treedata(pruned.tree.alps.sperma, alps.summits.pa)

# Random Draw Null 
obs.mntd.sperma <- ses.mntd(samp =t(alps.damocles.sperma$data)[c(3,10),], dis = cophenetic(alps.damocles.sperma$phy), null.model = "phylogeny.pool", runs = 1000)
obs.mpd.sperma <- ses.mpd(samp =t(alps.damocles.sperma$data)[c(3,10),], dis = cophenetic(alps.damocles.sperma$phy), null.model = "phylogeny.pool", runs = 1000)
write.csv(obs.mntd.sperma, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mntd.persis.sperma.csv")
write.csv(obs.mpd.sperma, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mpd.persis.sperma.csv")

# DAMOCLES null 
damo.bs.sperma <- DAMOCLES_bootstrap(
  phy = alps.damocles.sperma$phy,
  pa = alps.damocles.sperma$data[,c(1, 10)],  # LGM (persistent) species pool only
...
write.csv(damo.bs.sperma$null_community_data, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/Spermatophyta.persis.null_community_data.csv")
write.csv(damo.bs.sperma$summary_table, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/Spermatophyta.persis.summary_table.csv")
...
write.csv(obs.mntd.aster, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mntd.persis.aster.csv")
write.csv(obs.mpd.aster, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mpd.persis.aster.csv")
...
write.csv(damo.bs.aster$null_community_data, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/asterales.persis.null_community_data.csv")
write.csv(damo.bs.aster$summary_table, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/asterales.persis.summary_table.csv")
...
write.csv(obs.mntd.poales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mntd.persis.poales.csv")
write.csv(obs.mpd.poales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mpd.persis.poales.csv")
...
write.csv(damo.bs.poales$null_community_data, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/poales.persis.null_community_data.csv")
write.csv(damo.bs.poales$summary_table, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/poales.persis.summary_table.csv")
...
write.csv(obs.mntd.lamiales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mntd.persis.lamiales.csv")
write.csv(obs.mpd.lamiales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mpd.persis.lamiales.csv")
...
write.csv(damo.bs.lamiales$null_community_data, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/lamiales.persis.null_community_data.csv")
write.csv(damo.bs.lamiales$summary_table, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/lamiales.persis.summary_table.csv")
...
write.csv(obs.mntd.caryophyllales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mntd.persis.caryophyllales.csv")
write.csv(obs.mpd.caryophyllales, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/obs.mpd.persis.caryophyllales.csv")
...
write.csv(damo.bs.caryophyllales$null_community_data, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/caryophyllales.persis.null_community_data.csv")
write.csv(damo.bs.caryophyllales$summary_table, file="output/8_PhyoDiversity/alpha/dynamic/speciesPools/2_allSummits/LGM/caryophyllales.persis.summary_table.csv")
