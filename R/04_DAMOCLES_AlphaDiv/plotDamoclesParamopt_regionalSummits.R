...
############# Regional species pool to All Summits community  #######################################################
############# Hannah E. Marx, 6 June 2016 ###########################################################################
#####################################################################################################################

### read in ML estimates of parameters 
sperma.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.sperma.summary.csv", stringsAsFactors=F)
aster.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.asterales.summary.csv", stringsAsFactors=F)
caryo.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.caryoph.summary.csv", stringsAsFactors=F)
lamial.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.lamiales.summary.csv", stringsAsFactors=F)
poales.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.poales.summary.csv", stringsAsFactors=F)
rosales.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.rosales.summary.csv", stringsAsFactors=F)
...
write.csv(rbind(Spermatophyta = summary(sperma.opt)[4,], 
                ...
                Caryophyllales = summary(caryo.opt)[4,]), file="output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/clade.opt.summary.mean.csv")
...
opt.plot.comb
pdf(file="output/8_PhyoDiversity/alpha/dynamic/figs/parameter.opt_regional_AllSummits.pdf")
opt.plot.comb
dev.off()
