...
############# Community of summit species within the ‘Regional’ Écrins NP species pool
...
## Repeat optimization of parameters 30 times to see if they converge 
...
for (i in 1:30){
  ...
  write.csv(opt.params.spermatophyta, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.spermatophyta.", args[1], ".csv", sep=""))
  ...
  write.csv(opt.params.asterales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.asterales.", args[1], ".csv", sep=""))
  ...
  write.csv(opt.params.poales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.poales.", args[1], ".csv", sep=""))
  ...
  write.csv(opt.params.rosales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.rosales.", args[1], ".csv", sep=""))
  ...
  write.csv(opt.params.lamiales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.lamiales.", args[1], ".csv", sep=""))
  ...
  write.csv(opt.params.caryophyllales, file=paste("output/8_PhyoDiversity/alpha/dynamic/paramOpt/1_regionalEcrins/AllSummits/clades/opt.params.caryophyllales.", args[1], ".csv", sep=""))
