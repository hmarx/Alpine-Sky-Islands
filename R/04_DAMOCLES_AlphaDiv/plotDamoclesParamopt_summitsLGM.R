...
sperma.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.sperma.summary.csv", stringsAsFactors=F)
aster.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.asterales.summary.csv", stringsAsFactors=F)
caryo.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.caryoph.summary.csv", stringsAsFactors=F)
lamial.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.lamiales.summary.csv", stringsAsFactors=F)
rosales.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.rosales.summary.csv", stringsAsFactors=F)
poales.LGM.opt <- read.csv("output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/output/opt.poales.summary.csv", stringsAsFactors=F)
...
write.csv(rbind(Spermatophyta = summary(sperma.LGM.opt)[4,], 
                ...
                Caryophyllales = summary(caryo.LGM.opt)[4,]), file="output/8_PhyoDiversity/alpha/dynamic/paramOpt/2_AllSummits/best/allsummits.LGM.opt.summary.mean.csv")
