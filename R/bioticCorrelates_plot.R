...
pdf(file="output/9_PhyoDiversity/Spermatophyta/Endemics/rd_SES_tile_NOendemics.pdf")
plot.mpd.NOendemics
dev.off()
...
multi.tree.slices.alpha.df <- read.csv("output/9_PhyoDiversity/Spermatophyta/Time/multi.tree.slices.alpha.csv", as.is=T)
...
#plot_alpha_time
pdf(file="output/9_PhyoDiversity/Spermatophyta/Time/plot_alpha_time.pdf")
plot_alpha_time
dev.off()
