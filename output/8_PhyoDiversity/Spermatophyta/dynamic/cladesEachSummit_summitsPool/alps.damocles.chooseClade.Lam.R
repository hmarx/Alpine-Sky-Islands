...
for (i in 2:ncol(alps.damocles.lamiales$data)){
  ...
  write.csv(damo.bs.lamiales$null_community_data, file=paste("lamiales.null_community_data.", i, ".csv", sep=""))
  write.csv(damo.bs.lamiales$summary_table, file=paste("lamiales.summary_table.", i, ".csv", sep=""))
