...
source("alps.damocles.chooseClade.ecrins.R")
...
alps.damocles.sperma <- treedata(pruned.tree.alps.sperma, alps.sites.pa)
...
write.csv(damo.bs.sperma$null_community_data, file=paste("spermatophyta.ecrins.null_community_data.", i, ".csv", sep=""))
write.csv(damo.bs.sperma$summary_table, file=paste("spermatophyta.ecrins.summary_table.", i, ".csv", sep=""))
