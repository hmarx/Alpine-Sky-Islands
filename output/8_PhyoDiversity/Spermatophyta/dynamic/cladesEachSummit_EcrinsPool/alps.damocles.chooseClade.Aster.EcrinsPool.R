...
write.csv(damo.bs.aster$null_community_data, file=paste("asterales.ecrins.null_community_data.", i, ".csv", sep=""))
write.csv(damo.bs.aster$summary_table, file=paste("asterales.ecrins.summary_table.", i, ".csv", sep=""))
