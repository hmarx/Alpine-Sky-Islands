...
write.csv(damo.bs.caryophyllales$null_community_data, file=paste("caryophyllales.ecrins.null_community_data.", i, ".csv", sep=""))
write.csv(damo.bs.caryophyllales$summary_table, file=paste("caryophyllales.ecrins.summary_table.", i, ".csv", sep=""))
