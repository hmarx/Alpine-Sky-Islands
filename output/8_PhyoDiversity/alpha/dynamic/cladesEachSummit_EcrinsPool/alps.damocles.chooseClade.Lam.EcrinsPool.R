...
write.csv(damo.bs.lamiales$null_community_data, file=paste("lamiales.ecrins.null_community_data.", i, ".csv", sep=""))
write.csv(damo.bs.lamiales$summary_table, file=paste("lamiales.ecrins.summary_table.", i, ".csv", sep=""))
