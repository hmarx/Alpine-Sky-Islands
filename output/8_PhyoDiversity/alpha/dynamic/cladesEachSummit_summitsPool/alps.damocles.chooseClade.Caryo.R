...
for (i in 2:ncol(alps.damocles.caryophyllales$data)){
  ...
  write.csv(damo.bs.caryophyllales$null_community_data, file=paste("caryophyllales.null_community_data.", i, ".csv", sep=""))
  write.csv(damo.bs.caryophyllales$summary_table, file=paste("caryophyllales.summary_table.", i, ".csv", sep=""))
