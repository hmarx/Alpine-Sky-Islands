...
write.csv(damo.bs.poales$null_community_data, file=paste("poales.persistent.null_community_data.", i, ".csv", sep=""))
write.csv(damo.bs.poales$summary_table, file=paste("poales.persistent.summary_table.", i, ".csv", sep=""))
