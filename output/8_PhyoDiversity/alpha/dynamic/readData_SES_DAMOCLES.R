...
##################### Read and combine all output of DAMOCLES across summits with summits, persistent, and Ecrins source pools


################################ Summits Source Pool ################################ 
source(file="output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_summitsPool/alps.damocles.Clade.AllSummits.R")

DAMOCLES_summits_aster <- data.frame()
for (i in c(2:7, 9:16)){
  file = paste("asterales.summary_table", i, "csv", sep=".")
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_summitsPool/Asterales/", file, sep=""))
...
for (i in 2:16){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_summitsPool/Caryo/", file, sep=""))
  summary_tab <- t(as.data.frame(summary$value, strings.as.factors=F))
  colnames(summary_tab) <- t(as.data.frame(summary[,2]))
...
for (i in 2:16){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_summitsPool/Lamiales/", file, sep=""))
...
for (i in 2:16){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_summitsPool/Poales/", file, sep=""))
  summary_tab <- t(as.data.frame(summary[,3], strings.as.factors=F))
  colnames(summary_tab) <- t(summary[,2])
...
persistent.ast.EcrinsPool.summary <- read.csv("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_EcrinsPool/persistent/asterales.persis.summary_table.csv")
...
persistent.poa.EcrinsPool.summary <- read.csv("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_EcrinsPool/persistent/poales.persis.summary_table.csv")
...
persistent.lam.EcrinsPool.summary <- read.csv("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_EcrinsPool/persistent/lamiales.persis.summary_table.csv")
...
persistent.cary.EcrinsPool.summary <- read.csv("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_EcrinsPool/persistent/caryophyllales.persis.summary_table.csv")
...
################################ Persistent source pool ################################ 

DAMOCLES_persistent_aster <- data.frame()
for (i in c(2:16)){
  file = paste("asterales.persistent.summary_table", i, "csv", sep=".")
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_persistentPool/Asterales/", file, sep=""))
  summary_tab <- t(as.data.frame(summary$value, strings.as.factors=F))
  colnames(summary_tab) <- t(as.data.frame(summary[,2]))
...
for (i in c(2:9, 11:12, 14:16)){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_persistentPool/Caryo/", file, sep=""))
  summary_tab <- t(as.data.frame(summary$value, strings.as.factors=F))
  colnames(summary_tab) <- t(as.data.frame(summary[,2]))
...
for (i in 3:16){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_persistentPool/Lamiales/", file, sep=""))
  summary_tab <- t(as.data.frame(summary[,3], strings.as.factors=F))
  colnames(summary_tab) <- t(summary[,2])
...
for (i in 2:16){
  ...
  summary <- read.csv(paste("output/9_PhyoDiversity/Spermatophyta/dynamic/cladesEachSummit_persistentPool/Poales/", file, sep=""))
  summary_tab <- t(as.data.frame(summary[,3], strings.as.factors=F))
  colnames(summary_tab) <- t(summary[,2])
...
head(ses.master)
#write.csv(ses.master, file="output/9_PhyoDiversity/Spermatophyta/dynamic/master.ses.dynamic.alpha.csv")
...
pdf("output/9_PhyoDiversity/Spermatophyta/dynamic/damocles_SES_tile.pdf_all_pools.pdf")
ses.rd.damo
dev.off()
...
pdf("output/9_PhyoDiversity/Spermatophyta/dynamic/damocles_SES_tile_pools.pdf")
ses.damo
dev.off()
...
write.csv(rate_summary, file="output/9_PhyoDiversity/Spermatophyta/dynamic/clade_summit_summary.csv")
