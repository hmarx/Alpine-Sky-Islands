...
write.csv(opt.params.poales, file=paste("opt.params.poales.", args[1], ".csv", sep=""))
...
write.csv(opt.params.rosales, file=paste("opt.params.rosales.", args[1], ".csv", sep=""))
...
write.csv(opt.params.lamiales, file=paste("opt.params.lamiales.", args[1], ".csv", sep=""))
