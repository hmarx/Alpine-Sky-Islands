...
write.csv(obs.mntd.caryophyllales, file="obs.mntd.persis.caryophyllales.csv")
write.csv(obs.mpd.caryophyllales, file="obs.mpd.persis.caryophyllales.csv")

damo.bs.caryophyllales <- DAMOCLES_bootstrap(
  phy = alps.damocles.caryophyllales$phy,
  pa = alps.damocles.caryophyllales$data[,c(1, 10)],  #summits P/A,
...
write.csv(damo.bs.caryophyllales$null_community_data, file="caryophyllales.persis.null_community_data.csv")
write.csv(damo.bs.caryophyllales$summary_table, file="caryophyllales.persis.summary_table.csv")
